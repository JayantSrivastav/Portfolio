...
import JavaSpring from "../assets/Javaspringboot.png";
...
import Native from "../assets/reactnativelogo.png";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Hi, I'm Jayant Srivastava
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              A Full-Stack Developer with expertise in web development, mobile
              development, MERN Stack, React Native and JAVA Spring Boot.
            </p>
          </div>
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-600">
                  ...
                  Mobile Development (React Native) have built Projects such as
                  a full-stack coding plateform Code Collab, Meta Games,
                  DoneWithIt App & a Ecommerce App .
                  <br />
                  My projects demonstrate my ability to integrate poweful
                  backend solutions with sleek, user-friendly frontend designs.
                </p>
                <div className="flex space-x-4 mt-4 items-center">
                  <img
                    src={MernStack}
                    alt="Mern Stack"
                    className="p-2 rounded-lg w-44 h-auto object-contain"
                  />
                  <img
                    src={ReactNative}
                    alt="React Native"
                    className="p-2 rounded-lg w-40 h-auto object-contain"
                    style={{
                      maxHeight: "85px",
                    }} /* Adjust the height to match others */
                  />
                  <img
                    src={JavaSpring}
                    alt="Java Spring"
              ...
              <div className="border border-red-200 rounded-lg md:p-7 py-7  flex flex-col gap-8 items-center shadow-lg shadow-red-300">
                ...
                <div className="flex items-center justify-center flex-wrap gap-3">
                  ...
                  <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                    <img src={Native} alt="" className="w-9" />
                  ...
                  <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                    <img src={Spring} alt="" className="w-9" />
                    <span className="font-semibold">Spring Boot</span>
                  </div>
                  <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                    <img src={JDBC} alt="" className="w-9" />
                    <span className="font-semibold">JDBC</span>
                  </div>
                  <div className="border border-red-300 flex items-center gap-1 w-max px-2 py-1 rounded-lg shadow-md shadow-red-300">
                    <img src={Micro} alt="" className="w-9" />
          ...
          <div className="mt-12">
            ...
            <p className="mt-4 text-lg text-gray-600">
              ...
              Development, Mobile Development JAVA Development & intrested towards DevOps.
            </p>
          </div>
        </div>
      </div>
